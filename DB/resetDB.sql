...
CREATE TABLE companies (
  ...
  company_selection ENUM('self', 'fifo', 'manual') NULL,
  company_working_style ENUM('normal', 'secondary') NULL,
  ...
  company_tax_structure ENUM('product_wise', 'bill_wise') NULL,
  company_financial_year_start DATE NULL,
  company_financial_year_end DATE NULL,
  company_data_dir VARCHAR(100) NOT NULL,
  company_reg ENUM('registered', 'composition', 'un_registered') NULL,
  company_valuation ENUM('last_purchase', 'avg_rate', 'self_feeding') NULL,
